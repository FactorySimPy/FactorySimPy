...
MACHINE1 = Machine(env, id="MACHINE1",node_setup_time=0,work_capacity=3,blocking=True, processing_delay=1,in_edge_selection="ROUND_ROBIN",out_edge_selection=0)

SINK= Sink(env, id="SINK")

# Initializing edges
BUFFER1 = Buffer(env, id="BUFFER1", store_capacity=1, delay=0.5, mode="FIFO")
BUFFER2 = Buffer(env, id="BUFFER2", store_capacity=1, delay=0.5, mode="FIFO")
