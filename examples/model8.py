...
MACHINE1 = Machine(env, id="MACHINE1",work_capacity=1,blocking=True, processing_delay=0.3,in_edge_selection="FIRST_AVAILABLE",out_edge_selection="FIRST_AVAILABLE")
...
MACHINE4 = Machine(env, id="MACHINE4",work_capacity=3,blocking=True, processing_delay=0.2,in_edge_selection="ROUND_ROBIN",out_edge_selection="FIRST_AVAILABLE")
MACHINE5 = Machine(env, id="MACHINE5",work_capacity=3,blocking=True, processing_delay=0.5,in_edge_selection=0,out_edge_selection="RANDOM")
...
print(f"Total items generated {SRC1.stats['num_item_generated'] + SRC2.stats['num_item_generated'] + SRC3.stats['num_item_generated']}")
